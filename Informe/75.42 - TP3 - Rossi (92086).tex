...
\section{Esquema del diseño}
	...
	A continuación, en la \textit{Figura 1}, se ilustra el diagrama de flujo que representa la secuencia de ejecución de los distintos procesos que se deben llevar a lo largo de cada parte del programa.
